...
<!-- 添加或修改Dialog -->
<div id="sysUserEditDialog" class="easyui-dialog form-layout" 
			...
			<input name="userId" type="hidden">
			 <table cellpadding="0" class="table_xz" cellspacing="0" width="100%">
	    		<tr>
	    			...
	    			<td><input class="textbox-gray" type="text" name="name" readonly="true" style="width:200px"></td>
	    		</tr>
	    		<tr>
	    		...
	    		<tr>
	    			...
	    			<td><input type="password" class="easyui-textbox easyui-validatebox" name="confirmPwd"
						validType="equals['$(\'#editPwd\').val()','两次密码不一致.']" style="width: 200px"></td>
	    		</tr>
	    		<tr>
	    		...
	    		<tr>
	    			<td>角色:</td>
	    			<td><div id="sysUserEditRoles"></div></td>
	    		</tr>
	    	</table>
	</form>
</div>
<div id="sysUserEdit-dlg-buttons">
	<a class="easyui-linkbutton qd" id="sysUserEditSaveBtn" 
		onclick="sysUser.edit()">修改</a> <a class="easyui-linkbutton qd"
		
		onclick="javascript:uiEx.closeDialog('#sysUserEditDialog');uiEx.closeDialog('#DwtreeDialog')">取消</a>
</div></div>
