...
public class SysLogCriteria extends EasyCriteria implements java.io.Serializable {
	...
	public String getCondition() {
		...
		if (StringUtil.isNotNullAndEmpty(this.getEndTime())) {
			try {
