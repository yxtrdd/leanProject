...
<!-- 修改或修改Dialog -->
<div id="sysRoleEditDialog" class="easyui-dialog form-layout" 
...
<div id="sysRoleEdit-dlg-buttons">
	<a class="easyui-linkbutton qd" id="sysRoleEditSaveBtn" 
		onclick="sysRole.edit()">修改</a> <a class="easyui-linkbutton qd"
