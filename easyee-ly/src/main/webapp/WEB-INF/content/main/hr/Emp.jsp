...
<%-- 2. 页面内容 --%>
<table id="empDataGrid" title="员工列表" style="width: 100%"
	toolbar="#empToolbar" idField="empno" rownumbers="true"
...
<div id="empToolbar">
	<div class="b_line_bar b_bar_h">
		<form action="" id="EmpSearchForm">
			<div class="text FL">
				...
				<div class="text1 FL">
					<span>职务:</span> <input name="job" id="empJob"
						class="easyui-textbox" />
				</div>
				<div class="text1 FL">
					<span>部门:</span> <select name="deptno" class="easyui-combobox"
						id="empDeptno" style="width: 90px;"
						data-options="editable:false,panelHeight:'auto'">
					</select>
				</div>
				<div class="bt FL">
					<a class="easyui-linkbutton bt_bg" iconCls="icon-search"
						plain="true" onclick="Emp.doSearch()"><s:message
							code="label.search"></s:message></a> <a
						class="easyui-linkbutton bt_bg" iconCls="icon-clear"
						plain="true" onclick="Emp.clearAll()"><s:message
							code="label.clear"></s:message></a>
				</div>
		</form>
	</div>
	<div class="b_bar_h">
	...
	<a class="easyui-linkbutton bt_bg" iconCls="icon-remove" plain="true"
