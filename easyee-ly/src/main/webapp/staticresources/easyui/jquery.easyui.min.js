...
/* add by gaojx  class="bt_bg" */
var _295=$("<a href=\"javascript:void(0)\" class=\"bt_bg\"></a>").appendTo(_294);
if(p.handler){
...
/* add by gaojx  class="bt_bg" */
$("<a href=\"javascript:void(0)\" style=\"margin-left:10px\" class=\"bt_bg\"></a>").appendTo(tb).linkbutton(btn);
});
}
