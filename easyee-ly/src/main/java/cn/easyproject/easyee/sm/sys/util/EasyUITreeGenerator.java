...
public class EasyUITreeGenerator {
	...
	public static List<EasyUITreeEntity> getEasyUITreeMenu(List<SysMenuPermission> menus) {
		...
		for (SysMenuPermission sysMenuPermission : menus) {
			...
			easyUITreeRoot.setParentId(sysMenuPermission.getSysMenuPermission() != null
					? sysMenuPermission.getSysMenuPermission().getMenuPermissionId() + "" : "0");
			...
			easyUITreeRoot.setOpenMode(sysMenuPermission.getOpenMode());
	...
	static List<EasyUITreeEntity> getEasyUITreeMenuAndOperation(List<Map<Object, Object>> menusAndOperations) {
		...
		for (Map<Object, Object> map : menusAndOperations) {
			...
			easyUITreeRoot.setOpenMode(map.get("OPENMODE") + "");
	 ...
	 * @return EasyUI菜单tree集合
	 */
	static List<EasyUITreeEntity> getEasyUITreeMenuAndOperationUsePrefixId(
			List<Map<Object, Object>> userMenusAndOperations) {
		List<EasyUITreeEntity> list = new ArrayList<EasyUITreeEntity>();
