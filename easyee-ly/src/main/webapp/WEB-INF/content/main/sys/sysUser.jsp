...
<script type="text/javascript">
	...
	$(function() {
		...
		dg.initDatagrid({
			...
			destroyUrl : "SysUser/deleteBatch",
		...
		sysUser.toDelete = function() {
			...
			var rows = $("#sysUserDataGrid").datagrid('getChecked');
...
<div id="sysUserToolbar">
	<div class="b_line_bar b_bar_h">
		<div class="text FL"><span>用户名:</span> <input name="name" id="sysUserName" class="easyui-textbox" /></div>
		<div class="text FL"><span>真实姓名:</span> <input name="realName" id="sysRealName" class="easyui-textbox" /></div>
		<div class="text FL"><span>状态:</span> <select name="status" class="easyui-combobox"
		...
		<div class="bt FL">
			<a class="easyui-linkbutton bt_bg" iconCls="icon-search" plain="true" onclick="sysUser.doSearch()"><s:message code="label.search"></s:message></a>
		</div>			
	</div>
	<div class="b_bar_h">	
				...
				<shiro:hasPermission name="sysUserDelBtn">
					<a class="easyui-linkbutton bt_bg"
