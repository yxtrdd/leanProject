...
<div id="deptToolbar">
	...
	<form action="" id="DeptSearchForm" onclick="Dept.doSearch()">
		<div class="text FL"><span>部门名称:</span> <input name="dname" id="deptName" class="easyui-textbox" /></div>
		<div class="text1 FL"><span>地址:</span> <input name="loc" id="deptLoc" class="easyui-textbox" /></div>
		<div class="bt FL"><a class="easyui-linkbutton bt_bg" iconCls="icon-search" plain="true" onclick="Dept.doSearch()"><s:message code="label.search"></s:message></a>
		<a class="easyui-linkbutton bt_bg" iconCls="icon-clear" plain="true" onclick="Dept.clearAll()"><s:message code="label.clear"></s:message></a>
		</div>
	</form>
	</div>
	<div class="b_bar_h">
	<a href="javascript:void(0)" class="easyui-linkbutton bt_bg" data-options="iconCls:'icon-add',plain:true" onclick="$('#deptDataGrid').edatagrid('addRow')">添加部门</a>
	<shiro:hasPermission name="deptDeleteShow">
		<a class="easyui-linkbutton bt_bg" iconCls="icon-remove" plain="true" onclick="$('#deptDataGrid').edatagrid('destroyRow')">删除部门</a>
	</shiro:hasPermission>
	<a class="easyui-linkbutton bt_bg" iconCls="icon-undo" plain="true" onclick="javascript:$('#deptDataGrid').edatagrid('cancelRow')">撤销修改</a>
   </div>
</div>
