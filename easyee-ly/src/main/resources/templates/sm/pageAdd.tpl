...
<%-- 2. Dialog --%>
<div id="${ClassName}AddDialog" class="easyui-dialog form-layout" style="width:650px;height:auto;" resizable="true" closed="true" buttons="#${ClassName}Add-dlg-buttons">
	<div class="ftitle">${ClsLabel}<s:message code="label.info"></s:message></div>
	<form id="${ClassName}AddForm" method="post" <#if addMutilpart>enctype="multipart/form-data" action="${ClassName}/save"</#if>>
...
<div id="${ClassName}Add-dlg-buttons">
	<a class="easyui-linkbutton qd" onclick="${ClassName}.add()" id="${ClassName}AddSaveBtn"><s:message code="label.add"></s:message></a>
	<a class="easyui-linkbutton qd" onclick="javascript:uiEx.closeDialog('#${ClassName}AddDialog')"><s:message code="label.cancel"></s:message></a>
</div>