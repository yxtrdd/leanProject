...
<script type="text/javascript">
	...
	$(function() {
		...
		sysRole.toAdd = function() {
			...
			uiEx.initParentIdTreeChk("#sysRoleAddPermissions", {
		...
		function toEdit(row) {
			...
			$.post("SysRole/getAllPermissionsId", "roleId="
				 ...
				 * 初始化权限复选框
				 */
				uiEx.initParentIdTreeChk("#sysRoleEditPermissions", {
					url : "SysMenuPermission/listAllForSysRole",
					checkbox : true,
					animate : true,
					lines : true,
 ...
 --%>	<%-- 2. 页面内容 --%>
	...
	<div id="sysRoleToolbar">
		<div class="b_line_bar b_bar_h">
			<div class="text FL"><span>角色名:</span> <input name="name" id="sysRoleName"
				class="easyui-textbox" /> </div>
				<div class="text1 FL"><span>状态:</span> <select
			...
			<div class="bt FL">
			<a class="easyui-linkbutton bt_bg" iconCls="icon-search" plain="true"
		...
		<a href="javascript:void(0)" class="easyui-linkbutton bt_bg"
			...
			class="easyui-linkbutton bt_bg"
			data-options="iconCls:'icon-edit',plain:true"
			onclick="sysRole.toEdit()">修改角色</a> <a class="easyui-linkbutton bt_bg"
