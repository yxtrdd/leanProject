...
<div id="sysLogToolbar">
	<div class="b_line_bar b_bar_h">
		<div class="text FL"><span>账户:</span> <input name="account" id="sysLogAccount" class="easyui-textbox" /></div>
		<div class="text1 FL"><span>IP:</span> <input name="ip" id="sysLogIp" class="easyui-textbox" /></div>
		<span>操作日期:</span>
		...
		<a class="easyui-linkbutton bt_bg" style="heiht:10px" iconCls="icon-search" plain="true"
