...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#sysOperationPermissionMenuDataGrid").initParentIdTreegrid({
        ...
        //setHeight();
        $('#sysOperationPermissionLayout').layout();
	});
</script>

<div id="sysOperationPermissionLayout" style="width:100%;height:100%" >
	<div id="p" data-options="region:'west',iconCls:'icon-menu',collapsible:false,split:true"
		title="菜单列表" style="width:25%;height:100%">
		<table id="sysOperationPermissionMenuDataGrid" rownumbers="true"
			fitColumns="true">
			<thead>
				<tr>
					<th data-options="field:'text'" style="width:200px; ">菜单项</th>
				</tr>
			</thead>
		</table>
	</div>
...
<div class="b_bar_h">
	<a href="javascript:void(0)" class="easyui-linkbutton bt_bg"
		data-options="iconCls:'icon-add',plain:true"
		onclick="sysOperationPermission.toAdd()">添加操作权限</a> <a
		class="easyui-linkbutton bt_bg" iconCls="icon-remove" plain="true"
		onclick="$('#sysOperationPermissionDataGrid').edatagrid('destroyRow')">删除操作权限</a>
	<a class="easyui-linkbutton bt_bg" iconCls="icon-undo" plain="true"
