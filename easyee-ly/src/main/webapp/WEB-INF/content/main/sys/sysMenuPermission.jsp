...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#sysMenuPermissionDataGrid").initParentIdTreegrid({
...
<%-- 支持创建根节点：url:'SysMenuPermission/list2 --%>
		...
		function toEdit(row) {
			...
			uiEx.loadForm("#sysMenuPermissionEditForm", rowData, "");
			//父菜单选择
...
<table id="sysMenuPermissionDataGrid" title="菜单权限列表" style=""
	...
	<thead>
		<tr>
			...
			<th data-options="field:'openMode'" width="100">打开方式</th>
...
<div class="b_bar_h">
	<a href="javascript:void(0)" class="easyui-linkbutton bt_bg"
		...
		href="javascript:void(0)" class="easyui-linkbutton bt_bg"
