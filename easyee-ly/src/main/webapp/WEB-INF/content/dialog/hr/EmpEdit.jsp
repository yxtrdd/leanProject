...
<!-- 添加或修改Dialog -->
<div id="empEditDialog" class="easyui-dialog form-layout" style="width:550px;height:auto;padding:0px 0px;"  resizable="true" closed="true"
			...
			<input name="empno" type="hidden">
			 <table cellpadding="0" class="table_xz" cellspacing="0" width="100%">
				...
				data-options="" ><span class="required">*</span></td>
	    			...
	    			<td><input class="easyui-textbox easyui-validatebox" name="job"
				></td>
	    		</tr>
	    		<tr>
	    			<td class="td_bg">部门:</td>
	    			<td>
						<input id="editDeptno" name="dept.deptno" required="true"> <span class="required">*</span>				
					</td>
	    		</tr>
	    	</table>
	</form>
...
<div id="empEdit-dlg-buttons">
	<a class="easyui-linkbutton qd" id="empEditSaveBtn" 
		onclick="Emp.edit()">修改</a> <a class="easyui-linkbutton qd"
